            ...
            <>
              ...
              <Zoom in={open}>
                <Fab
                  color="secondary"
                  aria-label="option3"
                  style={{ position: "absolute", bottom: 1, right: 80 }}
                >
                  ...
                  <ul className="list-group">
                    {filteredBySearchTerm.length === 0 ? (
                      ...
                      filteredBySearchTerm.map((todo, index) => (
                        <li
                          key={index}
                          className="list-group-item d-flex justify-content-between align-items-center bg-dark border-0 text-white"
                        >
                          <span
                            style={{
                          ...
                          <div className="d-flex gap-2">
                            <Button
                              ...
                              className="btn-sm"
                              onClick={() =>
                                handleToggleCompletion(index, todo.completed)
                              }
                            >
              ...
              <div className="edit-form">
                <div className="mt-3 text-center">
                  <div className="input-group d-block text-center">
                    <label htmlFor="title" style={{ marginBottom: "20px" }}>
                      New Task
                    </label>
                    <input
                      type="text"
